...
namespace profile.wire.Model
{
    ...
    /// ProfileSettingDto
    /// </summary>
    [DataContract(Name = "ProfileSettingDto")]
    public partial class ProfileSettingDto : IEquatable<ProfileSettingDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProfileSettingDto" /> class.
        /// </summary>
        ...
        public ProfileSettingDto(bool available = default(bool), int? timeIncludeFrom = default(int?), int? timeIncludeTo = default(int?), long? dateExcludeFrom = default(long?), long? dateExcludeTo = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProfileSettingDto {\n");
        ...
        {
            return this.Equals(input as ProfileSettingDto);
        }

        /// <summary>
        /// Returns true if ProfileSettingDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ProfileSettingDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProfileSettingDto input)
        {
            if (input == null)
            {
                return false;
